	...
	\begin{lstlisting}[language=json]
{
    ...
    \item Gli ordini stop sul file database vengono salvati con il prezzo dell'ordine market che li ha eseguiti, mentre nella struttura dati in memoria, mantengono il prezzo della richiesta.
