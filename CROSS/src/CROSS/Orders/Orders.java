...
public abstract class Orders {
     ...
     * 
     * Synchronized method to prevent multiple threads to add orders at the same time.
     * 
     ...
     * 
     */
    public static synchronized <GenericOrder extends Order> void addOrder(GenericOrder order) throws InvalidOrder, NullPointerException, Exception {
    ...
    /**
     * 
     * Load all the orders from the JSON database file.
     * 
     * It's a synchronized method to prevent multiple threads to load orders from the file at the same time.
     * 
     ...
     * 
     */
    public static synchronized void loadOrders() throws Exception {
    ...
    /**
     * 
     * Find an order with its order's id as Integer in the database.
     * 
    ...
    public static Order getOrder(Integer id) throws NullPointerException, RuntimeException {
        ...
        // Null check.
        if (id == null) {
            throw new NullPointerException("Order's id of the order to search in the database cannot be null.");
        }
        ...
        LimitOrder toSearchLimit = new LimitOrder(new SpecificPrice(1, PriceType.ASK, market), new Quantity(1), new User("placeholder", "placeholder"));
     ...
     * 
     */
    public static Integer getOrdersSize() throws RuntimeException {
